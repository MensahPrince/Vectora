...
pub use audio::{
    ...
    audio_peaks_per_second, denoise_interleaved, detect_beats, duck_gain, onset_envelope,
    reduce_curve, render_denoised, render_stretched, render_stretched_curve, speech_band_energy,
};
