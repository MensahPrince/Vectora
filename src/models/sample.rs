...
fn track(id: &str, name: &str, clips: Vec<Clip>) -> Track {
...
pub fn sample_project() -> Project {
    ...
    let tracks = vec![
        track("1", "Track 1", vec![clip("1", "Clip 1", 10, 10, 100, &fps)]),
        track(
            "2",
            "Track 2",
            vec![
        ...
        track("3", "Track 3", vec![clip("4", "Clip 4", 50, 0, 90, &fps)]),
        track(
            "4",
            "Track 4",
            vec![
        ...
        track("5", "Track 5", vec![clip("7", "Clip 7", 0, 0, 200, &fps)]),
    ];
